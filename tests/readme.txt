...
srilm-1.7.2/bin/cygwin64/disambig.exe -keep-unk -map  example/small-example.3.lc.az-ar.lex+word -text example/small-example.1.arabizi.ENTOK.lc -lm lm/moroccan_arabic_corpus_01.lm -order 3 -nbest 3
